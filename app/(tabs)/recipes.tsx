...
const styles = StyleSheet.create({
  ...
  cardTitle: { color: '#172033', fontWeight: '750', fontSize: 18 },
  cardDescription: { color: '#64748b', marginTop: 5, lineHeight: 19 },
  cardMeta: { color: '#94a3b8', fontSize: 12, marginTop: 8, fontWeight: '650' },
  chevron: { color: '#94a3b8', fontSize: 32 },
  empty: { alignItems: 'center', padding: 54 },
  emptyEmoji: { fontSize: 44 },
  emptyTitle: { fontSize: 20, fontWeight: '750', color: '#334155', marginTop: 13 },
  ...
  detailTitle: { fontSize: 34, fontWeight: '850', color: '#172033' },
